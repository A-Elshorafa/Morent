...
To update the database use this command from the Web project folder (replace `Morent` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Morent.Infrastructure/Morent.Infrastructure.csproj -s Morent.Web.csproj
```
