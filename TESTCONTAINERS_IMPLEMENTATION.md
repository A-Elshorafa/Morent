...
**Updated `tests\Morent.FunctionalTests\Morent.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Morent.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Morent.FunctionalTests\Morent.FunctionalTests.csproj
```
